...
export default new Obraz (76, 76, function (ctx, bx, by, par) {
	...
	kolo (ctx, "black", bx + 20, by + 20, 8);
	kolo (ctx, "black", bx + 56, by + 20, 8);
	kolo (ctx, "black", bx + 20, by + 56, 8);
	kolo (ctx, "black", bx + 56, by + 56, 8);
	kolo (ctx, "black", bx + 20, by + 38, 8);
	kolo (ctx, "black", bx + 56, by + 38, 8);
	}, null);
